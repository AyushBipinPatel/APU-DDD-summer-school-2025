...
[See [this](https://docs.surveycto.com/02-designing-forms/01-core-concepts/09.expressions.html) page to browse through applying other logical and mathematical operations.]{.fragment fragment-index="5"}<br><br>
