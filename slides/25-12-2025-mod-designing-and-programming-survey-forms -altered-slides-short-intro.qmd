...
author: "Ayush Patel"
subtitle: "Short introduction and fundamentals of SurveyCTO"
...
[Intermediate and Advanced features of SurveyCTO]{.fragment fragment-index="5"}
...
# Reckless Learning-1 (10-15 Mins){.smaller}

:::{.incremental}

  - Navigate to your own SurveyCTO console. Explore the Design, Collect, Monitor, Export and Configure tabs.
  - Using the Design tab in server console, upload [this](https://docs.google.com/spreadsheets/d/1-d543t2ZT3ljmQqQhEI3xL7vllv8Qlz8/edit?usp=drive_link&ouid=112023433242202033015&rtpof=true&sd=true) form.
  - Use the SurveyCTO Collect app to get the blank form.
  - Use the SurveyCTO Collect app to record data using the new form for any people/students around you. Or pretend to be the surveyor and the respondent inorder to fill the form.
  - Use the SurveyCTO Collect app to submit the collected form(s).
  - Go to the console. In the Export tab, find the submitted data. Get this data and take a look.
...
## Reckless Learning-3 (10-15 mins) {.smaller}
...
[Street vendors (vegetable, pani-puri, momos, etc) take credit through informal sources.]{.fragment fragment-index="1"}<br><br>
[Goal is to design a survey that provides information on incedence of credit/debt and rates of interests]{.fragment fragment-index="2"}<br><br>
[Design a survey that asks if the respondent is curretnly in debt. If they are, ask about the duration since they are in debt. Also ask if they are comfortable sharing the rate of interest and principal. Make sure if you have the yearly or monthly interest rate.]{.fragment fragment-index="3"}<br><br>
[if they are not in debt, ask them where would they get a loan and what do they expect the interest to be.]{.fragment fragment-index="4"}<br><br>
[Make sure you begin by asking for consent. Always explain why and what are you doing]{.fragment fragment-index="5"}

# Try yourself

[Design a survey to see people's estimates of thei screen times]{.fragment fragment-index="1"}<br><br>
[Begin by asking for conset. Record their age.]{.fragment fragment-index="2"}<br><br>
[Ask them to guess their total screen time]{.fragment fragment-index="3"}<br><br>
[Record the social media app they think they use the most, and their guess on the time spent on it.]{.fragment fragment-index="4"}<br><br>
[Now record actual total total screen time, actual screen time of the social media app they think they use the most, and the actual screen time of highest used social media app if this is not the expected social media app of the respondent. ]{.fragment fragment-index="5"}
